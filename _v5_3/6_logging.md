...
Det vil da logges til en logger med navn `Difi.Oppslagstjeneste.RequestLog`.
...
Eksempel på App.config med Log4Net-adapter for vanlig debug-logg samt en logger for forespørsel og response:
...
<configuration>
  ...
  <log4net>
    ...
    <logger name="Difi.Oppslagstjeneste.RequestLog">
      <appender-ref ref="RequestRollingFileAppender" />
      <level value="DEBUG" />
    </logger>
    <appender name="DebugRollingFileAppender" type="log4net.Appender.RollingFileAppender">
      <lockingModel type="log4net.Appender.FileAppender+MinimalLock" />
    ...
    <appender name="RequestRollingFileAppender" type="log4net.Appender.RollingFileAppender">
      <lockingModel type="log4net.Appender.FileAppender+MinimalLock" />
