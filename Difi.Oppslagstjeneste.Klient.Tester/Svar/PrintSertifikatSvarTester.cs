    ...
    public class PrintSertifikatSvarTester
    {
        ...
        public static void Init(TestContext context)
        {
            try
            {
                ...
                var mottattPrintSertifikatResponse =
                    Encoding.UTF8.GetString(resourceUtility.ReadAllBytes(true, "HentPrintSertifikatResponseDecryptert.xml"));
                var xmlDocument = new XmlDocument();
                xmlDocument.LoadXml(mottattPrintSertifikatResponse);
