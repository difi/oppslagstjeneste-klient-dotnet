...
namespace Difi.Oppslagstjeneste.Klient.Tester.Domene
{
    ...
    public class PersonTester
    {
        ...
        public void HentMobiltelefonnummerOgMetadataSuksess()
        {
            ...
            Assert.AreEqual(new DateTime(2015, 04, 14, 14, 35, 19), _person.Kontaktinformasjon.Mobiltelefonnummer.SistOppdatert);
            Assert.AreEqual(new DateTime(2015, 04, 14, 14, 35, 19), _person.Kontaktinformasjon.Mobiltelefonnummer.SistVerifisert);
        }
        ...
        public void HentSertifikatSuksess()
        {
            ...
            Assert.AreEqual(new X509Certificate2(certificateData), _person.X509Sertifikat);
        }
